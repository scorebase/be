            ...
            .then(res => {
                ...
                const schema = joi.object({
                    ...
                    standing : joi.array().items(joi.object({
                        ...
                        total_pts : joi.number().integer().min(0).required(),
                        round_score : joi.number().integer().min(0).required(),
                        total_exact : joi.number().integer().min(0).required(),
                        total_close : joi.number().integer().min(0).required(),
                        total_outcome : joi.number().integer().min(0).required(),
                    })),
